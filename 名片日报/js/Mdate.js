    ...
    Mdate.prototype = {
        ...
        dateSure: function() {
            ...
            sureBtn.onclick = function() {
                // yearTag + "年" +
                // yearTag + 
                if (that.format == "YMD") { that.acceptId.innerText = monthTag + "月" + dayTag + "日" } else { that.acceptId.innerText = that.dateForTen(monthTag) + that.format + that.dateForTen(dayTag) }
